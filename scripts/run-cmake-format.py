#!/usr/bin/env python
"""A wrapper script around cmake-format, suitable for linting multiple files
and to use for continuous integration.

This is an alternative API for the cmake-format command line.
        ...
        if recursive and os.path.isdir(file):
            for dirpath, dnames, fnames in os.walk(file):
                ...
                for f in fpaths:
                    ...
                    if ext in extensions or fileName == "CMakeLists.txt":
                        out.append(f)
        else:
            out.append(file)
    return out
...
def run_cmake_format_diff(args, file):
    ...
    if args.in_place:
        invocation = [args.cmake_format_executable, '-i', file]
    else:
        invocation = [args.cmake_format_executable, file]
...
def main():
    ...
    parser.add_argument(
        ...
        metavar='EXECUTABLE',
        help='path to the cmake-format executable',
    ...
    parser.add_argument(
        ...
        metavar='PATTERN',
        action='append',
        default=["./build"], # Exclue build directory by default
    ...
    version_invocation = [args.cmake_format_executable, str("--version")]
    try:
